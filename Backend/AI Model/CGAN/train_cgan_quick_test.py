...
DATA_DIM = 78
NUM_CLASSES = 15
EPOCHS = 5      # Only 5 epochs for a quick test
BATCH_SIZE = 64
...
# Use one-sided label smoothing for stability
...
for epoch in range(EPOCHS):
    ...
    # Generator is trained to fool the discriminator into predicting 'real' (1)
